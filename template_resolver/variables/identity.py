...
from core import GameContext, Team, TemplateContext
...
def _get_opponent(ctx: TemplateContext, game_ctx: GameContext | None) -> Team | None:
...
def extract_gracenote_category(
    ...
    # Could be enhanced to look up from database
    return "Sports event"
