...
def _is_home(ctx: TemplateContext, game_ctx: GameContext | None) -> bool | None:
    ...
    if not game_ctx or not game_ctx.event:
        return None
    if not game_ctx.event.home_team:
        return None
...
def extract_home_team(ctx: TemplateContext, game_ctx: GameContext | None) -> str:
    if not game_ctx or not game_ctx.event or not game_ctx.event.home_team:
        return ""
...
def extract_away_team(ctx: TemplateContext, game_ctx: GameContext | None) -> str:
    if not game_ctx or not game_ctx.event or not game_ctx.event.away_team:
        return ""
...
def extract_home_team_abbrev_lower(
    ctx: TemplateContext, game_ctx: GameContext | None
) -> str:
    if not game_ctx or not game_ctx.event or not game_ctx.event.home_team:
        return ""
...
def extract_away_team_abbrev_lower(
    ctx: TemplateContext, game_ctx: GameContext | None
) -> str:
    if not game_ctx or not game_ctx.event or not game_ctx.event.away_team:
        return ""
